...
<div class="container">
  <div class="preview">
    <img src="https://tronxmas.pro/images/tronxmas-1.gif">
  </div>
	<h2 class="text-center text-light my-3 gold">TronXmas Slot Game</h2>
	<div class="row justify-content-center mb-3">
		<div class="col col-auto">
			<canvas id="slot" width="370" height="240"></canvas>
		</div>
	</div>
	<div class="row justify-content-center mb-3">
		<div class="col col-auto">
			<div class="input-group mb-3 w-75 m-auto">
			  	<div class="input-group-prepend">
			    	<span class="input-group-text">Your Earning</span>
	...
	<div class="row justify-content-center mb-3">
		<div class="col col-auto">
			<button class="btn btn-danger px-5" id="spin" disabled><i class="fas fa-sync-alt"></i> SPIN</button><p>10 Level Required</p>
			<button class="btn btn-secondary px-5" id="auto" disabled><i class="fab fa-android"></i> AUTO SPIN(OFF)</button>
		</div>
	</div>
	<div class="row justify-content-center mb-3">
		<div class="col col-auto">
			<div class="input-group">
				...
				<input class="form-control" type="number" id="balance" min="1" max="5000" value="<?php echo $this->userdata->balance; ?>" disabled>
		...
		<div class="col col-auto">
			<div class="input-group">
				...
				<input class="form-control" type="number" id="bet" min="1" value="1" max="3" disabled>
				<div class="input-group-append">
	...
	<div class="row justify-content-center my-3">
		<div class="col col-auto">
			<button class="btn btn-warning w-auto" type="button" id="checkout" style="display:none;"><i class="fas fa-money-bill-alt"></i> CHECKOUT</button>
			<button class="btn btn-primary w-auto" type="button" data-toggle="modal" data-target="#payTable"  style="display:none;" ><i class="fas fa-money-bill-alt"></i> Pay Table</button>
		</div>
	</div>
</div>
...
let conf = {
	...
	player: {
		money: <?php echo $this->userdata->balance; ?>
	},
	imgDot: null,
	autoModeDelay: 3000,
	sound: {
...
//Resource loader
Resources(
		'/images/slot-tron.png', 
		'/images/slot-tether.png', 
		'/images/slot-xmas.png', 
		'/images/slot-diamond.png',
		'/images/slot-platinium.png'
	)
  ...
  document.querySelector('.preview').parentNode.
    removeChild(document.querySelector('.preview'));
		...
		names.forEach(function(name){
			let key = name.replace(new RegExp('^(https://tronxmas.pro/images/)|(.png|.jpg|.jpeg)$','ig'), ''),
